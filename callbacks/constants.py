...
class Constants(object):
    ...
    INTRO_PPI = "In this page, you can search for modules (communities or clusters) in rice protein-protein interaction networks related to your gene, and identify which genes implicated by your GWAS. Likely functions of the modules are inferred by enrichment analysis against several ontologies and pathway databases."
