...
from callbacks.coexpression.util import MODULE_DETECTION_ALGOS_VALUE_LABEL
from callbacks.ppi.util import PPI_NETWORKS_VALUE_LABEL
...
module_detection_algo_modal = dbc.Modal(
    [
        dbc.ModalHeader(dbc.ModalTitle("Module Detection Algorithms")),
        dbc.ModalBody(
            [
                html.P(
                    ...
                    [
                        ...
                        html.Li(
                            [
                                ...
                                html.Span(
                                    ", the parameter pertains to the merging threshold."
                                ),
                                html.Br(),
                                html.Span(
...
converter_modal = dbc.Modal(
    [
        dbc.ModalHeader(dbc.ModalTitle("Rice ID Converter")),
        dbc.ModalBody(
            [
                html.P(
                ...
                html.P(
                    [
                        ...
                        html.A(
                            "tool",
                            href="https://rapdb.dna.affrc.go.jp/converter/",
                            target="_blank",
                        ),
...
layout = html.Div(
    id={"type": "analysis-layout", "label": Constants.LABEL_PPI},
    hidden=True,
    children=[
        html.Div(
            [
                        ...
                        html.Div(
                            ...
                            children=[
                                ...
                                dbc.Tabs(
                                    ...
                                    children=[
                                        dcc.Tab(
                                            label="Gene Ontology", value="Gene Ontology"
                                        ),
                                        dcc.Tab(
                                        ...
                                        dcc.Tab(
                                            label="Pathways (Over-Representation)",
                                            value="Pathways (Over-Representation)",
                                        ),
                                        dcc.Tab(
                                            label="Pathway-Express",
                                            ...
                                            [
                                                cyto.Cytoscape(
                                                    ...
                                                    style={
                                                        "width": "100%",
                                                        "height": "100vh",
                                                    },  # Should be here (otherwise, initial loading does not consume entire width and height)
                                                    stylesheet=[
                                                        {
                                                            "selector": "node",
                                                            "style": {
